...
import { getAssociatedTokenAddressSync, createTransferCheckedInstruction, TOKEN_PROGRAM_ID, TOKEN_2022_PROGRAM_ID } from '@solana/spl-token';
...
export const TopUpForm: React.FC<TopUpFormProps> = ({
  ...
  const handlePayWithWallet = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Treasury ATA is created by backend on startup; frontend only does the transfer
